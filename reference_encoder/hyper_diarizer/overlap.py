...
try:
    overlap_model.load_state_dict(torch.load('path/to/overlap_weights.pth'))  # Replace with your path if weights exist
except FileNotFoundError:
    logging.warning("No pretrained weights for OverlapClassifier; using random init.")
