# prosody.py (Full Refined Patch: Load Model Once, Pass to Func, GPU Support)
...
try:
    ...
    import librosa
    import parselmouth
    def extract_prosody_fallback(chunk_path, hop_length, sr):
        # load audio
...
def process_speaker(args):
    ...
    if has_prosody3:
        ...
        model = None  # Fallback doesn't need model
