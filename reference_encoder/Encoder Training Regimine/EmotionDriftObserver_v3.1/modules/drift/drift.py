...
def run(context):
    ...
    plot_dir = global_config['plot_map_dir']
    ...
    for speaker_id in speaker_ids:
        ...
        boundaries = derive_segment_boundaries(duration, drift_points.tolist())
        ...
        drift_vector = {'deltas': smoothed_deltas.tolist(), 'slices': filtered_drifts, 'slice_boundaries': slice_boundaries, 'boundaries': boundaries}
