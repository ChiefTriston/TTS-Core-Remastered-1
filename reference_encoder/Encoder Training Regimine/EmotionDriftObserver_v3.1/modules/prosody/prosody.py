...
from pipeline import generate_segment_plot_map  # pull from your pipeline.py helper
...
def run(context):
    ...
    for speaker_id in speaker_ids:
        ...
        os.makedirs(global_config['plot_map_dir'], exist_ok=True)
        # call for full file or per-slice once you know your drift slices
        generate_segment_plot_map( full_scores=prosody_data['frame_series'], segment_start=0, segment_end=duration,
                                   clip_id=speaker_id, tier1_transition="", drift_reason="",
                                   save_dir=global_config['plot_map_dir'] )
